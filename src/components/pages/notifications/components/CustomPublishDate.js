...
const styleClasses =
  'w-5 h-5 b-0 m-0 border py-5 px-6 flex items-center justify-center'
...
CustomPublishDates.propTypes = {
  repeat: P.bool,
  repeatOption: P.object,
  dates: P.array,
  weekdays: P.array,
  repeatEveryOption: P.object,
